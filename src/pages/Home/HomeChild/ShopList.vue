...
<style scoped>
.msite_shop_list .shop_container {
  margin-bottom: 50px;
}
...
.shop_rating_order .shop_rating_order_right {
  float: right;
  font-size: 0;
}
...
.shop_rating_order_right .delivery_left {
  color: #fff;
  margin-right: -10px;
...
.shop_right .shop_distance {
  *zoom: 1;
  width: 100%;
  font-size: 12px;
}
.shop_right .shop_distance::after {
  content: "";
  display: block;
  clear: both;
}
